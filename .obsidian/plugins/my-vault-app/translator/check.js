...
const SYSTEM = [
  ...
  '',
  'Spelling slips and missing accents do NOT make it wrong. Mention those as',
  'ISSUE lines. A wrong tense, wrong number or wrong gender that changes the',
  'meaning DOES make it wrong.',
  '',
